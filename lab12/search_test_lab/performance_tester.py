...
def main():
    ...
    # test_linear_search(1000, 100, ordered=False)
    # test_linear_search(2000, 100, ordered=False)
    # test_linear_search(3000, 100, ordered=False)
    # test_linear_search(4000, 100, ordered=False)
    # test_linear_search(5000, 100, ordered=False)
    # test_linear_search(6000, 100, ordered=False)
    # test_linear_search(7000, 100, ordered=False)
    # test_linear_search(8000, 100, ordered=False)
    # test_linear_search(9000, 100, ordered=False)
    # test_linear_search(10000, 100, ordered=False)

    # test_linear_search(1000, 100, ordered=True)
    # test_linear_search(2000, 100, ordered=True)
    # test_linear_search(3000, 100, ordered=True)
    # test_linear_search(4000, 100, ordered=True)
    # test_linear_search(5000, 100, ordered=True)
    # test_linear_search(6000, 100, ordered=True)
    # test_linear_search(7000, 100, ordered=True)
    # test_linear_search(8000, 100, ordered=True)
    # test_linear_search(9000, 100, ordered=True)
    # test_linear_search(10000, 100, ordered=True)

    # test_binary_search(1000, 100)
    # test_binary_search(2000, 100)
    # test_binary_search(3000, 100)
    # test_binary_search(4000, 100)
    # test_binary_search(5000, 100)
    # test_binary_search(6000, 100)
    # test_binary_search(7000, 100)
    # test_binary_search(8000, 100)
    # test_binary_search(9000, 100)
